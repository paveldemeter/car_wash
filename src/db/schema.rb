...
ActiveRecord::Schema.define(version: 2019_11_08_123259) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.index ["cleaner_id"], name: "index_payments_on_cleaner_id"
  end
  ...
  add_foreign_key "payments", "users", column: "cleaner_id"
end
